  ...
  <div class="text-black" :class="wrapClass">
    <div ref="textRef" class="leading-relaxed break-words">
      <div v-if="!inversion" class="flex items-end">
        <div v-if="!asRawText" class="w-full markdown-body" v-text="text"></div>
        <div v-else class="w-full whitespace-pre-wrap" v-text="text"></div>
        <span v-if="loading" class="dark:text-white w-[4px] h-[20px] block animate-blink"></span>
      </div>
